...
export const todoValidator = [
    body('title').isString().notEmpty().withMessage("Email must be non empty string"),
    body('description').isString().notEmpty().withMessage("Password should be non-empty string"),
]